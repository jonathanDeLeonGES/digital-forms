...
- [x] 1. Configuración inicial del módulo acciones
- [x] 1.1 Crear la app Django `apps/acciones` con estructura de archivos base
...
- [x] 2. Modelos de datos: Accion y HistorialEstado
- [x] 2.1 Implementar el modelo `Accion` con máquina de estados
...
- [x] 2.2 Implementar el modelo `HistorialEstado` y generar migraciones
...
- [x] 3. Capa de servicio: AccionService y señal de dominio
- [x] 3.1 (P) Implementar `AccionService.create_accion` y `update_accion`
...
- [x] 3.2 (P) Implementar `AccionService.transition_state` y `_validate_transition`
...
- [x] 3.3 (P) Definir y emitir la señal `accion_estado_cambiado`
...
- [x] 4. API REST: serializers, filtros y viewset
- [x] 4.1 (P) Implementar serializers
...
- [x] 4.2 (P) Implementar `AccionFilter`
...
- [x] 4.3 Implementar `AccionViewSet` con todos los endpoints y acciones custom
...
- [x] 5. Integración con issues: transición automática
- [x] 5.1 Implementar `AccionService._trigger_issue_transition_if_needed`
...
- [x] 6. Frontend: módulo de acciones
- [x] 6.1 (P) Implementar `acciones.ts` service y `AccionListPage`
...
- [x] 6.2 (P) Implementar `AccionDetailPage` con historial y botones de transición
...
- [x] 6.3 (P) Implementar `AccionFormPage`
...
- [x] 7.1 (P) Tests unitarios del servicio y máquina de estados
...
- [x] 7.2 (P) Tests de integración de API
...
- [x] 7.3 Test E2E: flujo completo de acción
